...
export default ({onSidebarOpen}) => {
  ...
  return (
    <Navbar fluid className="border-b-2">
      <Link to="/">
        <Navbar.Brand as="div">
          <svg className="mr-3 h-6 w-6 sm:h-9 sm:w-9" width="250" height="250" viewBox="0 0 250 250" fill="none"
            ...
            <path
              ...
              stroke="#111820" strokeWidth="8" />
            <path d="M155.699 104.182V88.2727H218.909V104.182H197.034V161H177.574V104.182H155.699Z" fill="#111820" />
            <rect x="122" y="75" width="7" height="100" rx="3.5" fill="#111820" />
          </svg>

          <span className="self-center whitespace-nowrap text-xl font-semibold dark:text-white">LinhSa</span>
        </Navbar.Brand>
      </Link>
      ...
      <div className="flex md:order-2 gap-2">
        ...
        >
          ...
          <Dropdown.Divider/>
          <form id="signout-form" action="/users/sign_out" method="post" style={{display: 'none'}}>
